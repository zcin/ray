...
def get_block(node, **kwargs):
    ...
    # result_type is generated by ray.experimental.gradio_utils.type_to_string()
    if result_type == "int":
        ...
        if (
            issubclass(locate(result_type), ImageFile.ImageFile)
...
def postprocessing(data):
    ...
    For types like PyTorch tensors, which are not supported by Gradio, transform them
    into a form that Gradio can process and display.
    """
