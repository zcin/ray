...
class TestAutoscalingMetrics:
    ...
    def test_replicas_die(serve_instance, use_generator):
    ...
    def test_handle_deleted(self, serve_instance):
        ...
        wait_for_condition(check_num_replicas_eq, name="A", target=0, timeout=15)
        wait_for_condition(
            check_num_requests_eq, client=client, id=dep_id, expected=0, timeout=15
        )
...
def test_downscaling_with_fractional_scaling_factor(
    ...
    wait_for_condition(check_handle_metrics, handle=h)
