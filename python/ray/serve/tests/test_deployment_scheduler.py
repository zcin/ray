...
from ray.serve._private.test_utils import check_num_alive_nodes, get_node_id
...
class TestSpreadScheduling:
    ...
    def test_spread_deployment_scheduling_policy_downscale_head_node(
...
class TestCompactScheduling:
    ...
    @pytest.mark.parametrize("use_pg", [True, False])
    def test_next(self, ray_cluster, use_pg: bool):
        pass
