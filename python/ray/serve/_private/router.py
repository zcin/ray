...
class RouterMetricsManager:
    ...
    def __init__(
        ...
        self.num_running_requests = running_requests_gauge
        self.num_running_requests.set_default_tags(
            {
                "deployment": deployment_id.name,
                "application": deployment_id.app_name,
                "handle": self._handle_id,
    ...
    def __init__(
        ...
        *,
        ...
        self._metrics_manager = RouterMetricsManager(
            ...
            metrics.Gauge(
                "serve_num_requests_sent_to_replicas",
                description=(
                    "The current number of requests to this deployment that's "
                    "been assigned to and sent to execute on a replica."
                ),
