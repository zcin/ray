...
class RouterMetricsManager:
        ...
        if autoscaling_config:
            ...
            if RAY_SERVE_COLLECT_AUTOSCALING_METRICS_ON_HANDLE:
                ...
                self.metrics_pusher.register_or_update_task(
                    ...
                    # min(RAY_SERVE_HANDLE_AUTOSCALING_METRIC_RECORD_PERIOD_S, autoscaling_config.metrics_interval_s),
                    0.01,
                )
    ...
    def _add_autoscaling_metrics_point(self):
        ...
        self.metrics_store.add_metrics_point(
            {QUEUED_REQUESTS_ID: self.num_queued_requests}, timestamp
        )
        if RAY_SERVE_COLLECT_AUTOSCALING_METRICS_ON_HANDLE:
            self.metrics_store.add_metrics_point(
        ...
        self.metrics_store.filter_data(set(self.num_requests_sent_to_replicas.keys()))
        self.metrics_store.compact_data(
            time.time() - self.autoscaling_config.look_back_period_s
        )
