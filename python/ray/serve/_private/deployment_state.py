...
class HandleRequestMetric:
    actor_id: str
    lives_on_proxy_or_replica: bool
...
class DeploymentState:
    ...
    def drop_invalid_handle_metrics(self, alive_serve_actor_ids: Set[str]) -> None:
        ...
        for handle_id, handle_metric in list(self.handle_requests.items()):
            ...
            if (
                handle_metric.lives_on_proxy_or_replica
    ...
    def record_request_metrics_for_handle(
        ...
        if (
            ...
            self.handle_requests[handle_id] = HandleRequestMetric(
                actor_id=actor_id,
                lives_on_proxy_or_replica=lives_on_proxy_or_replica,
...
class DeploymentStateManager:
    ...
    def drop_invalid_handle_metrics(self, alive_proxy_actor_ids: Set[str]):
        ...
        for deployment_state in self._deployment_states.values():
            if deployment_state.should_autoscale():
                deployment_state.drop_invalid_handle_metrics(alive_serve_actor_ids)
