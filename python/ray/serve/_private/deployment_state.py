...
class DeploymentState:
    ...
    #         self.check_and_update_replicas()
    ...
    #         self.migrate_replicas_on_draining_nodes(draining_nodes=draining_nodes)

    #         upscale, downscale = self.scale_deployment_replicas()

    #         deleted, any_replicas_recovering = self.check_curr_status()
    #     except Exception:
    #         logger.exception(
...
class DeploymentStateManager:
    ...
    def update(self) -> bool:
        ...
        allow_active_compaction = all(
            ...
            # To be extra conservative, only actrively compact if there
