...
class AutoscalingState:
    ...
    def __init__(self, deployment_id: DeploymentID):
        ...
        # Map from replica ID to (timestamp, average number of ongoing requests)
        self._replica_average_ongoing_requests: Dict[
            ReplicaID, Tuple[float, float]
        ] = dict()
...
class AutoscalingStateManager:
    ...
    def register_deployment(
        ...
        """If deployment is an autoscaling deployment, register its info.
