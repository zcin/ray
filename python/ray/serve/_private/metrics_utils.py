...
class MetricsPusher:
    ...
    def __init__(
        ...
        self._async_sleep = sleep_coroutine
    ...
    async def metrics_task(self, name: str):
        ...
        while True:
            ...
            sleep_coroutine = self._async_sleep(self._tasks[name].interval_s)
            await asyncio.wait(
                [self._wait_on_stop_event, asyncio.create_task(sleep_coroutine)],
    ...
    def register_or_update_task(
        ...
        self._event_loop.create_task(self.metrics_task(name))
    ...
    async def shutdown(self):
        ...
        self.stop_tasks()
        await self._wait_on_stop_event
        self._tasks.clear()
