...
public class DeploymentConfig implements Serializable {
  ...
  /**
   * [DEPRECATED] The maximum number of queries that can be sent to a replica of this deployment without
  ...
  public DeploymentConfig setMaxConcurrentRequests(Integer maxConcurrentRequests) {
    if (maxConcurrentRequests != null) {
      Preconditions.checkArgument(maxConcurrentRequests > 0, "max_concurrent_requests must be > 0");
  ...
  public byte[] toProtoBytes() {
    // TODO(zcin): use this later
    int _maxConcurrentRequests;
    if (maxConcurrentRequests == null) {
      _maxConcurrentRequests = maxConcurrentQueries;
    } else {
  ...
  public io.ray.serve.generated.DeploymentConfig toProto() {
    io.ray.serve.generated.DeploymentConfig.Builder builder =
        io.ray.serve.generated.DeploymentConfig.newBuilder()
            .setNumReplicas(numReplicas)
            .setMaxConcurrentQueries(maxConcurrentRequests)
            .setGracefulShutdownWaitLoopS(gracefulShutdownWaitLoopS)
            .setGracefulShutdownTimeoutS(gracefulShutdownTimeoutS)
            .setHealthCheckPeriodS(healthCheckPeriodS)
            .setHealthCheckTimeoutS(healthCheckTimeoutS)
  ...
  public static DeploymentConfig fromProto(io.ray.serve.generated.DeploymentConfig proto) {
    ...
    deploymentConfig.setMaxConcurrentQueries(proto.getMaxConcurrentRequests());
    deploymentConfig.setMaxConcurrentRequests(proto.getMaxConcurrentRequests());
