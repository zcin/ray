...
def main(
    ...
    # "query_url": "https://testing-autoscaling-load-test-jrvwy.cld-kvedzwag2qa8i5bj.s.anyscaleuserdata-staging.com",
    # "query_auth_token": "JjSBq5r3GfxIrIHb2STzH0RqAlgBzIuLjKgY1GW4c2M",
    proc = subprocess.Popen(
        [
            "python",
            "workloads/locust_runner.py",
            # "https://testing-autoscaling-load-test-jrvwy.cld-kvedzwag2qa8i5bj.s.anyscaleuserdata-staging.com/",  # noqa
            status.query_url,
            "--token",
